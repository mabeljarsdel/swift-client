...
public typealias WithdrawalAddress = DepositAddress

public class Withdrawal: Codable {
    public var id: Int
    ...
    public var withdrawalAddress: WithdrawalAddress
    ...
    public required init(from decoder: Decoder) throws {
        ...
        withdrawalAddress = try container.decode(WithdrawalAddress.self, forKey: .withdrawalAddress)
